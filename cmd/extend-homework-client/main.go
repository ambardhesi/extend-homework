...
import (
	...
	httpClient "github.com/ambardhesi/extend-homework/internal/client"
...
func init() {
	...
	rootCmd.AddCommand(&cmdGetVirtualCards, &cmdGetVirtualCardTransactions, &cmdGetTransaction, &cmdSignIn)
}
